...
Crear repo en GitHub y subir la carpeta `tp/` completa
Ir a https://streamlit.io/cloud → Sign in con GitHub
New app → elegir repo → rama `main` → archivo: `app.py`
Deploy — URL pública lista en ~3 minutos
